...
import imageProduct from '../../asset/images/slider_3.jpg'
...
export const aProductDetailComponent = () => {
    const onChange = () => {}
  return (
    <>
    ...
    <Row style={{padding: '16px', background: '#fff', borderRadius: '4px'}}>
        ...
        <Col span={14}  style={{paddingLeft: '20px'}} >
            ...
            <WrapperPriceProduct>
                <WrapperPriceTextProduct>{formatter(220000)}</WrapperPriceTextProduct>
            </WrapperPriceProduct>
            <div style={{fontSize: '20px', fontWeight: '500'}}>
                <p>Kích thước lớn Đế Dày <b/>Tôm, thanh cua, mực và bông cải xanh tươi ngon trên nền sốt Pesto Xanh</p>
            </div>
